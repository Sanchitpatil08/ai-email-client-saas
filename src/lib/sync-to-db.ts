...
export async function syncEmailsToDatabse ( emails: EmailMessage [], accountId : string){
    console.log('attempting to sync emails to databse', emails.length )
...
async function upsertEmail ( email: EmailMessage , accountId: string, index: string){   
...
async function upsertEmailAddress (address : EmailAddress , accountId : string) {
    try {
        ...
        console.log('failed to upsert the email address,',error)
        return null;
    }
